package net.stardecimal.game.worm.bodies
...
class Fruit extends Image {
	Body body
	World world

	Fruit(World world1, float pos_x, float pos_y, float width, float height, float angle) {
		super(new Texture("worm/fruit.png"))
