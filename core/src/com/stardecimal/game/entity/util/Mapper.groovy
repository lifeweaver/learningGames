...
import com.stardecimal.game.entity.components.AiComponent
...
import com.stardecimal.game.entity.components.EnemyComponent
...
import com.stardecimal.game.entity.components.SoundEffectComponent
import com.stardecimal.game.entity.components.StateComponent
import com.stardecimal.game.entity.components.SteeringComponent
...
// 	static final ComponentMapper<WallComponent> wallCom = ComponentMapper.getFor(WallComponent.class)
	...
	static final ComponentMapper<AiComponent> aiCom = ComponentMapper.getFor(AiComponent.class)
}
