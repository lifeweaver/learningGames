...
import com.stardecimal.game.entity.systems.ParticleEffectSystem
import com.stardecimal.game.entity.systems.PhysicsDebugSystem
import com.stardecimal.game.entity.systems.PhysicsSystem
import com.stardecimal.game.entity.systems.RenderingSystem
import com.stardecimal.game.entity.systems.SteeringSystem
...
trait GameScreen {
	...
	void init(final GameJamGame game, Class leveFactoryClass, renderingConstants=null) {
		this.parent = game
